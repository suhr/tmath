...
ALLSPHINXOPTS   = -d $(BUILDDIR)/doctrees $(PAPEROPT_$(PAPER)) $(SPHINXOPTS) prose
# the i18n builder cannot share the environment and doctrees with the others
I18NSPHINXOPTS  = $(PAPEROPT_$(PAPER)) $(SPHINXOPTS) prose
...
tikz: build/church-rosser.svg build/cr-equiv.svg build/syn1.svg build/syn2.svg \
	...
	build/syn3.svg build/syn4.svg build/syn5.svg build/succ-rel.svg build/lt-rel.svg
